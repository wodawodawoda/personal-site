...
const Navigation = (props) => (
  <div className='navigation'>
    ...
    <NavLink exact to='/cv' className='navigation__link' activeClassName='navigation__link--active'><span className='far fa-file-alt'></span><span className="alt">CV</span></NavLink>
    <NavLink exact to='/contact' className='navigation__link' activeClassName='navigation__link--active'><span className='far fa-comment'></span><span className="alt">Kontakt</span></NavLink>
  </div>
);
