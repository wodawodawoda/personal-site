...
const Navigation = (props) => (
  <div className='navigation'>
    ...
    <NavLink exact to='/personal-site/skills' className='navigation__link' activeClassName='navigation__link--active'><span className='far fa-code'></span><span className="alt">Umiejętności</span></NavLink>
